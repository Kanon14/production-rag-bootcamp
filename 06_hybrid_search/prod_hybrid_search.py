...
# This is what Ensemble Retriever did internally

def hybrid_retrieve(query, retrievers, weights, k=3, rrf_k=60):
    '''Combine multiple retrievers using weighted Reciprocal Rank Fusions.'''
    ...
    return [doc for _, doc in sorted_docts[:k]]
"""
