"""
Topic: Long Context vs RAG - When to Use Each
...
def calculate_costs():
    ...
    long_context_input = doc_tokens + query_tokens # 100_000 + 100
    ...
    rag_input = (rag_chunks * tokens_per_chunk) + query_tokens # (4 * 500) + 100
    ...
    print()
    print("RAG (4 chunks x 500 tokens):")
